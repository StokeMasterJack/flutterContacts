...
class FavGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var g = new GridView.count(
        ...
        children: contacts
            .map((c) => new FavTile(
                contact: c, selected: selected, onTapContact: onContactTap, onLongPressContact: onContactLongPress))
            .toList());
...
class FavTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    Widget av = contact.thumbnail == null
    ...
    return new InkWell(
        ...
        child: Column(
          children: <Widget>[new SizedBox(height: 16.0), av, new SizedBox(height: 12.0), new Text(contact.fullName)],
        ));
  }
}
